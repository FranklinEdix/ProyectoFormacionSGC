...
class MenuSeguimientoEgresadoBar{
            ...
            */
            ...
            'menu' => [
                [
                    'text'       => 'Principal',
                    'icon'       => 'fas fa-home',
                    'url'        => 'SeguimientoEgresado/Principal?variable=8',
                    'can'        => ''
                ],
                ...
                [
                    ...
                    'url'        => 'SeguimientoEgresado/SubirEvidencia?variable=8',
                    'can'        => ''
                ],
                [
                    'text'       => 'Subir Indicador',
                    'icon'       => 'fas fa-check-square',
                    'url'        => 'SeguimientoEgresado/SubirIndicador?variable=8',
                    'can'        => ''
                ],
