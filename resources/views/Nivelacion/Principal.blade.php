                             ...
                             <section><br>
                                ...
                                <h4 class="bg_tittle">&nbsp; Control documentario</h4><br>
                                    ...
                                    <div class="container">
                                          <div class="row">
                                            <div class="col-lg-8" id="Tittle" >
                                              <h3>Plan de estudios - Perfil de ingreso</h3>
                                            </div>
                                        ...
                                        <div class="container">
                                          <div class="row">
                                            <div class="col-lg-8" id="Tittle" >
                                              <h3>Reporte de desempeño de ingresantes</h3>
                                            </div>
                                            {{--El filtro por programas--}}
                                            <div class="col-lg-4">
                                              <div class="dropdown">
                                    ...
                                    <div class="container">
                                          ...
                                          {{--Registros de ingresantes en nivelación--}}
                                    <div class="container">
                                          <div class="row">
                                            <div class="col-lg-8" id="Tittle" >
                                              <h3>Registros de ingresantes en nivelación</h3>
                                            </div>
                                            {{--El filtro por programas--}}
                                            <div class="col-lg-4">
                                              <div class="dropdown">
                                    ...
                                    <div class="container">
                                          <div class="row">
                                            <div class="col-lg-8" id="Tittle" >
                                              <h3>Informe de evaluación del Plan de nivelación</h3>
                                            </div>
                                            {{--El filtro por programas--}}
                                            <div class="col-lg-4">
                                              <div class="dropdown">
                                          ...
                                          {{--Plan de mejora para la nivelación de ingresantes--}}
                                    <div class="container">
                                          <div class="row">
                                            <div class="col-lg-8" id="Tittle" >
                                              <h3>Plan de mejora para la nivelación de ingresantes</h3>
                                            </div>
                                            {{--El filtro por programas--}}
                                            <div class="col-lg-4">
                                              <div class="dropdown">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td> <button id="1" type="" class="btn btn-success btn-circle btn-sm" onclick="mostraVentanaNivelacion(this.id)">  </button> </td>
                                                            </tr>
                                                                                    
                                                            <tr>
                                                                <td>2</td>
                                                                <td>Desempeño promedio de ingresantes</td>
                                                                <td> <button id="2" type="" class="btn btn-danger btn-circle btn-sm" onclick="mostraVentanaNivelacion(this.id)">  </button> </td>
                                                            </tr>
                                                            <tr>
                                                                <td>3</td>
                                                                <td>Desempeño promedio de ingresantes participantes en el programa de nivelación</td>
                                                                <td> <button id="3" type="" class="btn btn-warning btn-circle btn-sm" onclick="mostraVentanaNivelacion(this.id)">  </button> </td>
                                                            </tr>
                                                ...
                                                <div class="col-lg-5"> 
                                                  ...
                                                  <div id="v-pills-uno" style="display:none;">
                                                      <br><br>
                                                      <div class="card card-body">
                                                          <h6>Tasa de ingresantes en el programa de nivelación</h6>
                                                  ...
                                                  <div id="v-pills-dos" style="display:none;">
                                                    <br><br>
                                                    <div class="card card-body">
                                                        <h6>Desempeño promedio de ingresantes</h6>
                                                  ...
                                                  <div id="v-pills-tres" style="display:none;">
                                                    <br><br>
                                                    <div class="card card-body">
                                                        <h6>Desempeño promedio de ingresantes participantes en el programa de nivelacióne</h6>
