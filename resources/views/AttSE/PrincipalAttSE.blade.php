...
@section('title', 'ATTSeguimientoEgresado')
...
<div id="content">
    <section>
      <div class="container" id="AccesosDirectos">
        <div class="row">
          <div class="col-lg-12">
            <h2 class="tit_acc_direct">Accesos directos - ATT Seguimiento Egresado</h2>
            <br>
          </div>
        </div>
        <div class="row" >
            ...
            <div class="col-lg-2" title="Ingresar a Formación">
                <center>
                <a href="{{ url('PrinAttSeguimientoEgresado?variable=32') }}">
