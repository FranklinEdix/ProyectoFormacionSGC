...
<div id="VolverPrincipal">
    <a href="{{ url('PrinAttSeguimientoEgresado?variable=32') }}"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-caret-left-square-fill" viewBox="0 0 16 16">
