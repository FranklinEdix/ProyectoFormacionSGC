      ...
      <section>
        <div class="container">
          ...
          <div class="container div_container" id="graficos">
            ...
            <h4 class="bg">&nbsp; Indicadores</h4><br>
    
                <h5 class="parraf_formacion">Lista de Indicadores</h5> 
                      ...
                      <table id="table_id" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="">Borrar </a><a href="">Editar </a><a href="">Ver</a></td>
                            </tr>   
                            <tr>
          ...
          <br>
            {{--<div class="col-lg-8">
              <label> Subir archivo para documentacion</label>
              <br>
              <input type="file">
            </div>--}}
          </div>
