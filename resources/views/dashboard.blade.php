    ...
    <div class="w-100">
        <div id="content">
            ...
            <div class="container">
                ...
                <div class="col-lg-12">
                    <h1>FORMACIÓN</h1>
                    <p>Este proceso se aplica a estudiantes de primer año de pregrado, que muestran dificultades académicas en las competencias genéricas de comunicación y razonamiento matemático a la Escuela Profesional y se inicia con la generación del reporte de desempeño de ingresantes y culmina con la evaluación del plan de nivelación.</p>
                </div>
            </div>
        </div>
    </div>
...
@section('content')
            ...
            <section>
                <div class="container" id="graficos">
                    <h6>Reeporte General del Macroproceso Formación</h6>
