...
<div id="VolverPrincipal">
    <a href="{{ url('FormacionDirector?variable=15') }}"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-caret-left-square-fill" viewBox="0 0 16 16">
                              ...
                              <table id="table_id" class="table table-bordered table-striped table-hover">
                                  ...
                                  <tbody>
                                      <tr>
                                          ...
                                          <td>Registros de graduados</td>
                                          <td>Permanente</td>
                                          <td class="txt-estado">No subido</td>
                                      </tr>   
                                      <tr>
                                          <td class="text-center">02</td>
                                          <td>Registros de titulados</td>
                                          <td>Permanente</td>
                                          <td class="txt-estado">No subido</td>
                                      </tr>    
                                      <tr>
                                          <td class="text-center">03</td>
                                          <td>Convenio para prácticas profesionales</td>
                                          <td>Permanente</td>
                                          <td class="txt-estado">No subido</td>
                                      </tr>   
                                  </tbody>
