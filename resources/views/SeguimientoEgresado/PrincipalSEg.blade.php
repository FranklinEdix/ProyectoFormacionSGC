...
@section('title', 'SeguimientoEgresado')
    ...
    <section>
        <nav >
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              ...
              <a class="nav-link " id="nav-Actividades-tab" data-toggle="tab" href="#nav-Actividades" role="tab" aria-controls="nav-Actividades" aria-selected="false">Actividades</a>
            </div>
          </nav>
            ...
            <div class="tab-pane fade" id="nav-Documentacion" role="tabpanel" aria-labelledby="nav-Documentacion-tab">
                             ...
                             <section><br>
                                ...
                                <h4 class="bg_tittle">&nbsp; Control documentario</h4><br>
                                    ...
                                    {{--Plan de estudios - Objetivos Educacionales--}}
                                    <div class="container">
                                    <div class="row">
                                        <div class="col-lg-8" id="Tittle" >
                                        <h3>Plan de estudios - Objetivos Educacionales</h3>
                                        </div>
                                    ...
                                    {{--Registros de graduados--}}
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-8" id="Tittle" >
                                            <h3>Registros de graduados</h3>
                                            </div>
                                             {{--El filtro por facultades--}}
                                             <div class="col-lg-4">
                                                <div class="dropdown">
                                                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    Seleccione Facuktad</button>
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="#">INGENÍERIA</a>
                                                    <a class="dropdown-item" >MINAS</a>
                                                </div>
                                        ...
                                        <br>
                                    {{--Registros de titulados--}}
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-8" id="Tittle" >
                                            <h3>Registros de titulados</h3>
                                            </div>
                                            {{--El filtro por facultades--}}
                                            <div class="col-lg-4">
                                            <div class="dropdown">
                                                <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                Seleccione Facultad</button>
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="#">INGENÍERIA</a>
                                                <a class="dropdown-item" >MINAS</a>
                                            </div>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-8" id="Tittle" >
                                            <h3>Informe de inserción laboral de egresados</h3>
                                            </div>
                                    ...
                                    {{--Registros de actividades para fortalecer la inserción laboral--}}
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-8" id="Tittle" >
                                            <h3>Registros de actividades para fortalecer la inserción laboral</h3>
                                            </div>
                                        ...
                                        <br>    
                                    {{--Norma que regule los mecanismos de coordinación y alianzas estratégicas con el sector público y/o privado--}}
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-8" id="Tittle" >
                                            <h3>Norma que regule los mecanismos de coordinación y alianzas estratégicas con el sector público y/o privado</h3>
                                            </div>
                                    ...
                                    {{--Convenio para prácticas profesionales--}}
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-8" id="Tittle" >
                                            <h3>Convenio para prácticas profesionales</h3>
                                            </div>
                                            {{--El filtro por facultades--}}
                                            <div class="col-lg-4">
                                            <div class="dropdown">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-8" id="Tittle" >
                                            <h3>Programa de capacitación continua</h3>
                                            </div>
                                            {{--El filtro por programas--}}
                                            <div class="col-lg-4">
                                            <div class="dropdown">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-8" id="Tittle" >
                                            <h3>Reporte de satisfacción de empleadores sobre desempeño de egresados</h3>
                                            </div>
                                        ...
                                        <br> 
                                    {{--Reporte de satisfacción de egresados sobre su formación profesional--}}
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-8" id="Tittle" >
                                            <h3>Reporte de satisfacción de egresados sobre su formación profesional</h3>
                                            </div>
             ...
             <div class="tab-pane fade" id="nav-Indicadores" role="tabpanel" aria-labelledby="nav-Indicadores-tab">
                             ...
                             <section><br>
                                ...
                                <h4 class="bg_tittle">&nbsp; Indicadores de Gestion</h4><br>
                                        ...
                                        <center>
                                            <div class="">
                                                <button class="btn btn-primary" id="8" onclick="MostrarVentanaSeEgre(this.id)"> Ver Reporte General </button>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6" id="tablaInd">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>1</td>
                                                                <td>Tasa de inserción laboral.</td>
                                                                <td> <button id="1" type="" class="btn btn-success btn-circle btn-sm" onclick="MostrarVentanaSeEgre(this.id)">  </button> </td>
                                                            </tr>
                                                                                    
                                                            <tr>
                                                                <td>2</td>
                                                                <td>Porcentaje de egresados por promoción de ingreso.</td>
                                                                <td> <button id="2" type="" class="btn btn-danger btn-circle btn-sm" onclick="MostrarVentanaSeEgre(this.id)">  </button> </td>
                                                            </tr>
                                                            <tr>
                                                                <td>3</td>
                                                                <td>Porcentaje de graduados por promoción de ingreso.</td>
                                                                <td> <button id="3" type="" class="btn btn-warning btn-circle btn-sm" onclick="MostrarVentanaSeEgre(this.id)">  </button> </td>
                                                            </tr>
                                                            <tr>
                                                                <td>4</td>
                                                                <td>Porcentaje de titulados por promoción de ingreso.</td>
                                                                <td> <button id="4" type="" class="btn btn-success btn-circle btn-sm" onclick="MostrarVentanaSeEgre(this.id)">  </button> </td>
                                                            </tr>
                                                                                    
                                                            <tr>
                                                                <td>5</td>
                                                                <td>Porcentaje de satisfacción de egresados en relación a su formación profesional.</td>
                                                                <td> <button id="5" type="" class="btn btn-danger btn-circle btn-sm" onclick="MostrarVentanaSeEgre(this.id)">  </button> </td>
                                                            </tr>
                                                            <tr>
                                                                <td>6</td>
                                                                <td>Porcentaje de satisfacción de empleadores en relación al desempeño de los egresados.</td>
                                                                <td> <button id="6" type="" class="btn btn-warning btn-circle btn-sm" onclick="MostrarVentanaSeEgre(this.id)">  </button> </td>
                                                            </tr>
                                                            <tr>
                                                                <td>7</td>
                                                                <td>Porcentaje de egresados que logran los Objetivos Educacionales.</td>
                                                                <td> <button id="7"  type="" class="btn btn-success btn-circle btn-sm" onclick="MostrarVentanaSeEgre(this.id)">  </button> </td>
                                                            </tr>
                                                ...
                                                <div class="col-lg-5"> 
                                                    <div id="reportPage">
                                                        ...
                                                        <div class="card card-body">
                                                            ...
                                                            <canvas class="ventana8" id="myChartIndicadores" width="200" height="200"></canvas>
                                                            <br><br>
                                                        </div>
                                                    </div>   
                                                    <div id="v-pills-uno" style="display:none;">
                                                        <br><br>
                                                        <div class="card card-body">
                                                          <h6>Tasa de inserción laboral.</h6>
                                                    ...
                                                    <div id="v-pills-dos" style="display:none;">
                                                      <br><br>
                                                      <div class="card card-body">
                                                          <h6>Porcentaje de egresados por promoción de ingreso.</h6>
                                                    ...
                                                    <div id="v-pills-tres" style="display:none;">
                                                      <br><br>
                                                      <div class="card card-body">
                                                          <h6>Porcentaje de graduados por promoción de ingreso.</h6>
                                                          <canvas class="ventana3" id="myChartIndicadoresDona3" width="200" height="200"></canvas>
                                                      </div>
                                                    </div>
                                                    <div id="v-pills-cuatro" style="display:none;">
                                                      <br><br>
                                                      <div class="card card-body">
                                                          <h6>Porcentaje de titulados por promoción de ingreso.</h6>
                                                          <canvas class="ventana4" id="myChartIndicadoresDona4" width="200" height="200"></canvas>
                                                      </div>
                                                    </div>
                                                    <div id="v-pills-cinco" style="display:none;">
                                                      <br><br>
                                                      <div class="card card-body">
                                                          <h6>Porcentaje de satisfacción de egresados en relación a su formación profesional.</h6>
                                                          <canvas class="ventana5" id="myChartIndicadoresDona5" width="200" height="200"></canvas>
                                                      </div>
                                                    </div>
                                                    <div id="v-pills-seis" style="display:none;">
                                                      <br><br>
                                                      <div class="card card-body">
                                                          <h6>Porcentaje de satisfacción de empleadores en relación al desempeño de los egresados.</h6>
                                                          <canvas class="ventana6" id="myChartIndicadoresDona6" width="200" height="200"></canvas>
                                                      </div>
                                                    </div>
                                                    <div id="v-pills-siete" style="display:none;">
                                                        <br><br>
                                                        <div class="card card-body">
                                                            <h6>Porcentaje de egresados que logran los Objetivos Educacionales.</h6>
                                                            <canvas class="ventana7" id="myChartIndicadoresDona7" width="200" height="200"></canvas>
                                                        </div>
                                                      </div>
                                                  </div>
                                            </center>
                ...
                <div class="tab-pane fade" id="nav-Actividades" role="tabpanel" aria-labelledby="nav-Actividades-tab">
                    ...
                    <br>
                    <div class="container " id="graficos">
                        <h4 class="bg_tittle">&nbsp; Evidencias</h4>
...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('css/TargetsHover/SegEgresado.css') }}">
@stop
...
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    ...
    <script src="{{ asset('js/donaSeguimientoEgresado.js') }}"></script>
    {{--<script src="{{ asset('js/cambiarIndicador.js') }}"></script>--}}
