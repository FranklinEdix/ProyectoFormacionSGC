...
@section('title', 'SeguimientoEstudiante')
                             ...
                             <section><br>
                                ...
                                <h4 class="bg_tittle">&nbsp; Control documentario</h4><br>
                                    ...
                                    <div class="container">
                                      <div class="row">
                                        <div class="col-lg-6" id="Tittle" >
                                          <h3>Reporte de desempeño de estudiantes</h3>
                                        </div>
                                    ...
                                    <div class="container">
                                      <div class="row">
                                        <div class="col-lg-6" id="Tittle" >
                                          <h3>Reporte de tutoría académica</h3>
                                        </div>
                                        {{--El filtro por programas--}}
                                        <div class="col-lg-2">
                                          <div class="dropdown">
                                    ...
                                    {{--Reporte de atención psicopedagógica--}}
                                    <div class="container">
                                      <div class="row">
                                        <div class="col-lg-6" id="Tittle" >
                                          <h3>Reporte de atención psicopedagógica</h3>
                                        </div>
                                        {{--El filtro por programas--}}
                                    ...
                                    {{--Registros de consejería estudiantil--}}
                                    <div class="container">
                                      <div class="row">
                                        <div class="col-lg-6" id="Tittle" >
                                          <h3>Registros de consejería estudiantil</h3>
                                        </div>
                                        {{--El filtro por programas--}}
                                        <div class="col-lg-2">
                                          <div class="dropdown">
                                    ...
                                    <div class="container">
                                          <div class="row">
                                            <div class="col-lg-8" id="Tittle" >
                                              <h3>Programa de reforzamiento académico</h3>
                                            </div>
                                            {{--El filtro por programas--}}
                                            <div class="col-lg-4">
                                              <div class="dropdown">
                                    ...
                                    <div class="container">
                                          <div class="row">
                                            <div class="col-lg-8" id="Tittle" >
                                              <h3>Informe de ejecución del programa de reforzamiento académico</h3>
                                            </div>
                                            {{--El filtro por programas--}}
                                            <div class="col-lg-4">
                                              <div class="dropdown">
             ...
             <div class="tab-pane fade" id="nav-Indicadores" role="tabpanel" aria-labelledby="nav-Indicadores-tab">
                             ...
                             <section><br>
                                ...
                                <h4 class="bg_tittle">&nbsp; Indicadores de Gestion</h4><br>
                                        ...
                                        <center>
                                          <div class="">
                                            <button class="btn btn-primary" id="7" onclick="MostrarVentanaSE(this.id)"> Ver Reporte General </button>
                                          </div>
                                            <div class="row">
                                                <div class="col-lg-6" id="tablaInd">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>1</td>
                                                                <td>Desempeño estudiantil promedio.</td>
                                                                <td> <button id="1" type="" class="btn btn-success btn-circle btn-sm" onclick="MostrarVentanaSE(this.id)">  </button> </td>
                                                            </tr>
                                                                                    
                                                            <tr>
                                                                <td>2</td>
                                                                <td>Tasa de estudiantes en riesgo académico.</td>
                                                                <td> <button id="2" type="" class="btn btn-danger btn-circle btn-sm" onclick="MostrarVentanaSE(this.id)">  </button> </td>
                                                            </tr>
                                                            <tr>
                                                                <td>3</td>
                                                                <td>Tasa de atención con tutoría académica.</td>
                                                                <td> <button id="3" type="" class="btn btn-warning btn-circle btn-sm" onclick="MostrarVentanaSE(this.id)">  </button> </td>
                                                            </tr>
                                                            <tr>
                                                                <td>4</td>
                                                                <td>Tasa de atención con consejería estudiantil.</td>
                                                                <td> <button id="4" type="" class="btn btn-success btn-circle btn-sm" onclick="MostrarVentanaSE(this.id)">  </button> </td>
                                                            </tr>
                                                                                    
                                                            <tr>
                                                                <td>5</td>
                                                                <td>Porcentaje de satisfacción de estudiantes con la tutoría académica.</td>
                                                                <td> <button id="5" type="" class="btn btn-danger btn-circle btn-sm" onclick="MostrarVentanaSE(this.id)">  </button> </td>
                                                            </tr>
                                                            <tr>
                                                                <td>6</td>
                                                                <td>Eficacia del programa de reforzamiento académico.</td>
                                                                <td> <button id="6" type="" class="btn btn-warning btn-circle btn-sm" onclick="MostrarVentanaSE(this.id)">  </button> </td>
                                                            </tr>
                                                ...
                                                <div class="col-lg-5"> 
                                                  <div id="reportPage">
                                                      ...
                                                      <div class="card card-body">
                                                          ...
                                                          <canvas class="ventana7" id="myChartIndicadores" width="200" height="200"></canvas>
                                                          <br><br>
                                                      </div>
                                                  </div>   
                                                  <div id="v-pills-uno" style="display:none;">
                                                      <br><br>
                                                      <div class="card card-body">
                                                        <h6>Desempeño estudiantil promedio.</h6>
                                                  ...
                                                  <div id="v-pills-dos" style="display:none;">
                                                    <br><br>
                                                    <div class="card card-body">
                                                        <h6>Tasa de estudiantes en riesgo académico.</h6>
                                                  ...
                                                  <div id="v-pills-tres" style="display:none;">
                                                    <br><br>
                                                    <div class="card card-body">
                                                        <h6>Tasa de atención con tutoría académica.</h6>
                                                  ...
                                                  <div id="v-pills-cuatro" style="display:none;">
                                                    <br><br>
                                                    <div class="card card-body">
                                                        <h6>Tasa de atención con consejería estudiantil.</h6>
                                                  ...
                                                  <div id="v-pills-cinco" style="display:none;">
                                                    <br><br>
                                                    <div class="card card-body">
                                                        <h6>Porcentaje de satisfacción de estudiantes con la tutoría académica.</h6>
                                                  ...
                                                  <div id="v-pills-seis" style="display:none;">
                                                    <br><br>
                                                    <div class="card card-body">
                                                        <h6>Eficacia del programa de reforzamiento académico.</h6>
...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('css/TargetsHover/SegEstudiante.css') }}">
@stop
