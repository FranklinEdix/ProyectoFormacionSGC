...
<div id="VolverPrincipal">
  <a href="{{ url('PrincipalDocente?variable=22') }}"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-caret-left-square-fill" viewBox="0 0 16 16">
...
<div class="d-flex">
    <div class="w-100">
    <section>
        @include('layouts.TargetsDocente')    
</section>
@stop
