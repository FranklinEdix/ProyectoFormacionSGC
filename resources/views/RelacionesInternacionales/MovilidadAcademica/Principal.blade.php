...
@section('title', 'MovilidadAcademica')

@section('content_header')
<div id="VolverPrincipal">
    <a href="{{ url('PrinRelacionesInternacionales?variable=28') }}"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-caret-left-square-fill" viewBox="0 0 16 16">
...
<div class="w-100">
<section>
    @include('layouts.TargetsRelaInternacional')    
</section>
@stop
