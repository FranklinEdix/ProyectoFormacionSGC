        ...
        <div class="row" id="containerCards">
            ...
            <div class="card-header text-center" id="targetas">Seguimiento Egresado
                ...
                <div class="ver_mas card-footer">
                 <a href="{{ url('SEAtt?variable=33') }}" id="verMas" class="color" >Ver más <img  class="card__image icon_card icon-right"  src="https://image.flaticon.com/icons/png/512/189/189689.png" width="24" height="24" ></img></a>
                </div>
            </div>
            </div>             
        </div>
