<section>
    <div class="container text-center c-center">
        <div class="row" id="containerCards">
            ...
            <div class="card mb-4 margen " style="max-width: 14rem;" id="trageta-4">
            <div class="card-header text-center" id="targetas">Movilidad Academica
                </div>
                    <div class="card-body">
                ...
                <div class="ver_mas card-footer">
                 <a href="{{ url('MARelacionesInternacionales?variable=29') }}" id="verMas" class="color" >Ver más <img  class="card__image icon_card icon-right"  src="https://image.flaticon.com/icons/png/512/189/189689.png" width="24" height="24" ></img></a>
                </div>
            </div>
            </div>             
        </div>
