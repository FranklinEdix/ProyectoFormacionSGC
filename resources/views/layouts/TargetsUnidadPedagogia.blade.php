<section>
    <div class="container text-center c-center">
        <div class="row" id="containerCards">
            ...
            <div class="card-header text-center" id="targetas">Actividad Extracurricular
                </div>
                    <div class="card-body">
                ...
                <div class="ver_mas card-footer">
                 <a href="{{ url('AcExUnidadPedagogia?variable=31') }}" id="verMas" class="color" >Ver más <img  class="card__image icon_card icon-right"  src="https://image.flaticon.com/icons/png/512/189/189689.png" width="24" height="24" ></img></a>
                </div>
            </div>
            </div>             
        </div>
