...
<div id="VolverPrincipal">
    <a href="{{ url('PrincipalPsicopedagogia?variable=26') }}"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-caret-left-square-fill" viewBox="0 0 16 16">
...
<div class="w-100">
<section>
    @include('layouts.TargetsPsicopedagogia')    
</section>
@stop
                              ...
                              <table id="table_id" class="table table-bordered table-striped table-hover">
                                  ...
                                  <tbody>
                                      <tr>
                                          ...
                                          <td>Programa de reforzamiento académico</td>
                                          <td>Anual</td>
                                          <td class="txt-estado">No subido</td>
                                      </tr>   
                                      <tr>
                                          <td class="text-center">02</td>
                                          <td>Informe de ejecución del programa de reforzamiento académico</td>
                                          <td>Anual</td>
                                          <td class="txt-estado">No subido</td>
                                      </tr>       
                                  </tbody>
